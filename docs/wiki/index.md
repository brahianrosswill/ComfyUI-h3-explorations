...
| [`docs/h3_taomate.md`](../../docs/h3_taomate.md) | the TaoMate-H3 streaming adapter as a ComfyUI LoRA: its base, ours against kijai's copy, what a graph changes from the authors' runtime, and the probe and audio-freeze arms. Opened and parked 2026-09-15: the owner judged PDD8 far better in every scene |
