...
| [`t2va_dancer_stream_243`](#t2va-dancer-stream-243) | t2va | 243 | 10.125 | pinned | 0 | — | 157 | 1 | 0 | — | Push In | N/A | clean |
...
| [`t2va_cafe_kids`](#t2va-cafe-kids) | t2va | 345 | 14.375 | pinned | 0 | — | 296 | 1 | 2 | English | Push In | scored | clean |
...
| [`t2va_covered_market`](#t2va-covered-market) | t2va | 345 | 14.375 | pinned | 40 | — | 240 | 3 | 2 | English | Truck Left, Static Shot | N/A | clean |
...
| [`t2va_diner_back_alley`](#t2va-diner-back-alley) | t2va | 345 | 14.375 | pinned | 0 | — | 179 | 3 | 2 | English | Push In, Shake Slightly | N/A | clean |
| [`t2va_diner_breakup`](#t2va-diner-breakup) | t2va | 345 | 14.375 | pinned | 0 | — | 311 | 3 | 2 | English | Push In, Pull Out, Static Shot | scored | clean |
| [`t2va_diner_breakup_short`](#t2va-diner-breakup-short) | t2va | 345 | 14.375 | pinned | 0 | — | 455 | 4 | 2 | English | Push In, Pull Out, Static Shot, Shake Slightly | scored | clean |
...
| [`t2va_ferry_fog_deck`](#t2va-ferry-fog-deck) | t2va | 345 | 14.375 | pinned | 0 | — | 193 | 3 | 2 | English | Push In, Shake Slightly | N/A | clean |
| [`t2va_freight_elevator`](#t2va-freight-elevator) | t2va | 345 | 14.375 | pinned | 0 | — | 187 | 3 | 2 | English | Push In, Shake Slightly | N/A | clean |
...
| [`t2va_hospital_fire_escape`](#t2va-hospital-fire-escape) | t2va | 345 | 14.375 | pinned | 0 | — | 189 | 3 | 2 | English | Push In, Shake Slightly | N/A | clean |
...
| [`t2va_motel_breezeway`](#t2va-motel-breezeway) | t2va | 345 | 14.375 | pinned | 0 | — | 183 | 3 | 2 | English | Truck Left, Shake Slightly | N/A | clean |
...
| [`t2va_none_of_this_is_real`](#t2va-none-of-this-is-real) | t2va | 345 | 14.375 | pinned | 0 | — | 131 | 1 | 1 | English | Static Shot | N/A | clean |
| [`t2va_none_of_this_is_real_moving`](#t2va-none-of-this-is-real-moving) | t2va | 345 | 14.375 | pinned | 0 | — | 170 | 1 | 1 | English | Push In | N/A | clean |
| [`t2va_none_of_this_is_real_moving_camera`](#t2va-none-of-this-is-real-moving-camera) | t2va | 345 | 14.375 | pinned | 0 | — | 148 | 1 | 1 | English | Arc Shot | N/A | clean |
| [`t2va_none_of_this_is_real_moving_subject`](#t2va-none-of-this-is-real-moving-subject) | t2va | 345 | 14.375 | pinned | 0 | — | 165 | 1 | 1 | English | Static Shot | N/A | clean |
| [`t2va_none_of_this_is_real_untold`](#t2va-none-of-this-is-real-untold) | t2va | 345 | 14.375 | pinned | 0 | — | 123 | 1 | 1 | — | Static Shot | N/A | clean |
...
| [`t2va_parking_garage_pillar`](#t2va-parking-garage-pillar) | t2va | 345 | 14.375 | pinned | 0 | — | 186 | 3 | 2 | English | Truck Left, Shake Slightly | N/A | clean |
...
| [`t2va_precinct_archive_vault`](#t2va-precinct-archive-vault) | t2va | 345 | 14.375 | pinned | 0 | — | 181 | 3 | 2 | English | Push In, Static Shot | N/A | clean |
...
| [`t2va_rooftop_boiler_room`](#t2va-rooftop-boiler-room) | t2va | 345 | 14.375 | pinned | 0 | — | 183 | 3 | 2 | English | Truck Right, Static Shot | N/A | clean |
| [`t2va_safehouse_kitchen`](#t2va-safehouse-kitchen) | t2va | 345 | 14.375 | pinned | 0 | — | 181 | 3 | 2 | English | Push In, Pan Left | N/A | clean |
...
| [`t2va_song_flicker_lists`](#t2va-song-flicker-lists) | t2va | 345 | 14.375 | pinned | 0 | — | 132 | 2 | 1 | — | Truck Left, Static Shot | scored | clean |
...
| [`ref2va_diner_breakup_refs`](#ref2va-diner-breakup-refs) | ref2va | 345 | 14.375 | pinned | 1 | `h3_probe_refview2_diner_api` | 444 | 3 | 2 | English | Push In, Pull Out, Static Shot | scored | clean |
...
| [`ref2va_night_porter_refs`](#ref2va-night-porter-refs) | ref2va | 345 | 14.375 | pinned | 1 | `h3_probe_refview2_porter_api` | 350 | 2 | 1 | English | Zoom In, Static Shot | N/A | clean |
...
| [`ref2va_role_character_garment_environment`](#ref2va-role-character-garment-environment) | ref2va | 345 | 14.375 | yes | 13 | `h3_probe_capture_ref3_api` | 45 | 1 | 0 | — | Truck Right | N/A | 0 FAIL, 1 WARN (recorded; see the entry) |
...
| [`ref2va_stairwell_dialogue_backstage`](#ref2va-stairwell-dialogue-backstage) | ref2va | 345 | 14.375 | pinned | 1 | `h3_probe_refview2_stairwell_backstage_api` | 419 | 3 | 2 | English | Shake Slightly | N/A | clean |
| [`ref2va_stairwell_dialogue_circus`](#ref2va-stairwell-dialogue-circus) | ref2va | 345 | 14.375 | pinned | 1 | `h3_probe_refview2_stairwell_circus_api` | 422 | 3 | 2 | English | Shake Slightly | N/A | clean |
| [`ref2va_studio_dancer_close_refs`](#ref2va-studio-dancer-close-refs) | ref2va | 345 | 14.375 | pinned | 1 | `h3_probe_refview2_dancer_api` | 370 | 2 | 0 | — | Push In, Static Shot | N/A | clean |
...
Counted over the prompts above: 139 prompts, 76 with `non_diegetic_music: N/A`. The vendor's eight filled-in music lines across both guides carry two `N/A`; the shipped corpus, per `prompt_catalogue.md`, leans far harder to `N/A` than that, and this bank was written against that lean rather than to it.
...
| `192` | `t2va_dancer_shot_face`, `t2va_dancer_shot_floor`, `t2va_rooftop_pov`, `i2va_cargo_bay`, `ref2va_storyboard_bakery` |
| `209` | `t2va_box_office`, `fl2va_balloon`, `ref2va_quarry_continuation` |
| `226` | `t2va_clay_apiary`, `l2va_kite_festival` |
| `243` | `t2va_dancer_stream_243`, `t2va_radio_drama`, `l2va_rescue_hut`, `ref2va_radio_handover` |
...
| `345` | `t2va_appalachian_folk_cabin`, `t2va_arena_rock_video`, `t2va_cafe_kids`, `t2va_cartoon_vaudeville`, `t2va_castle_rampart`, `t2va_clinic_corridor`, `t2va_cooking_show_meltdown`, `t2va_courtroom_verdict`, `t2va_covered_market`, `t2va_crowd_churn_long`, `t2va_cyber_hacker_den`, `t2va_cyberpunk_music_video`, `t2va_delta_blues_porch`, `t2va_diner_back_alley`, `t2va_diner_breakup`, `t2va_diner_breakup_short`, `t2va_disco_roller_rink`, `t2va_ferry_fog_deck`, `t2va_freight_elevator`, `t2va_french_new_wave_cafe`, `t2va_frontier_standoff`, `t2va_gladiator_arena_tunnel`, `t2va_hardware_aisle_long`, `t2va_hardware_aisle_short`, `t2va_hiphop_rooftop_cypher`, `t2va_hospital_fire_escape`, `t2va_kpop_dance_studio`, `t2va_kungfu_tea_house`, `t2va_lighthouse`, `t2va_marching_band`, `t2va_medical_er_triage`, `t2va_motel_breezeway`, `t2va_nature_doc_arctic`, `t2va_newsroom_breaking`, `t2va_none_of_this_is_real`, `t2va_none_of_this_is_real_moving`, `t2va_none_of_this_is_real_moving_camera`, `t2va_none_of_this_is_real_moving_subject`, `t2va_none_of_this_is_real_untold`, `t2va_opera_grand_stage`, `t2va_orbital_airlock`, `t2va_parking_garage_pillar`, `t2va_pirate_deck_mutiny`, `t2va_police_interrogation`, `t2va_precinct_archive_vault`, `t2va_punk_basement_gig`, `t2va_rail_dolly_long`, `t2va_rehearsal_room`, `t2va_restaurant_kitchen`, `t2va_rooftop_boiler_room`, `t2va_safehouse_kitchen`, `t2va_samurai_bamboo_duel`, `t2va_screwball_restaurant`, `t2va_sitcom_kitchen`, `t2va_slapstick_moving_piano`, `t2va_song_flicker_lists`, `t2va_sortline_long`, `t2va_sortline_short`, `t2va_speakeasy_heist`, `t2va_stairwell_dialogue`, `t2va_steampunk_airship_bridge`, `t2va_studio_dancer`, `t2va_studio_dancer_close`, `t2va_subway_chase`, `t2va_subway_maintenance_alcove`, `t2va_subway_platform`, `t2va_trench_ww1_messenger`, `t2va_victorian_seance`, `t2va_ww2_sub_sonar`, `i2va_lighthouse_keyframe`, `fl2va_interior_converge`, `l2va_interior_converge`, `l2va_laundromat`, `ref2va_diner_breakup_refs`, `ref2va_five_label`, `ref2va_image_audio_music`, `ref2va_image_audio_voice`, `ref2va_image_ref_default`, `ref2va_image_video_audio_music`, `ref2va_image_video_structure`, `ref2va_market_stallholder`, `ref2va_night_porter_refs`, `ref2va_role_character_environment`, `ref2va_role_character_garment_environment`, `ref2va_scene_kitchen`, `ref2va_scene_subway`, `ref2va_stairwell_dialogue`, `ref2va_stairwell_dialogue_backstage`, `ref2va_stairwell_dialogue_circus`, `ref2va_studio_dancer_close_refs`, `ref2va_video_character_swap`, `ref2va_video_continuation`, `ref2va_video_garment_edit`, `ref2va_video_image_edit`, `ref2va_video_motion_transfer`, `ref2va_video_sound_structure`, `ref2va_video_structure_only` |
...
| value | prompts |
|---|---|
| `Zoom In` | `t2va_night_porter`, `t2va_cooking_show_meltdown`, `t2va_disco_roller_rink`, `t2va_frontier_standoff`, `t2va_hiphop_rooftop_cypher`, `t2va_kungfu_tea_house`, `t2va_opera_grand_stage`, `t2va_samurai_bamboo_duel`, `t2va_screwball_restaurant`, `t2va_sitcom_kitchen`, `t2va_slapstick_moving_piano`, `t2va_victorian_seance`, `t2va_ww2_sub_sonar`, `fl2va_potter_wheel`, `ref2va_night_porter_refs` |
| `Zoom Out` | `t2va_noodle_bar`, `t2va_castle_rampart`, `i2va_glassblower`, `l2va_kite_festival`, `ref2va_soundtrack_fully_copy` |
| `Push In` | `t2va_dancer_shot_face`, `t2va_clay_apiary`, `t2va_dancer_stream_243`, `t2va_desert_crew`, `t2va_appalachian_folk_cabin`, `t2va_arena_rock_video`, `t2va_cafe_kids`, `t2va_cooking_show_meltdown`, `t2va_courtroom_verdict`, `t2va_cyber_hacker_den`, `t2va_cyberpunk_music_video`, `t2va_delta_blues_porch`, `t2va_diner_back_alley`, `t2va_diner_breakup`, `t2va_diner_breakup_short`, `t2va_ferry_fog_deck`, `t2va_freight_elevator`, `t2va_gladiator_arena_tunnel`, `t2va_hardware_aisle_long`, `t2va_hardware_aisle_short`, `t2va_hospital_fire_escape`, `t2va_kpop_dance_studio`, `t2va_kungfu_tea_house`, `t2va_lighthouse`, `t2va_medical_er_triage`, `t2va_newsroom_breaking`, `t2va_none_of_this_is_real_moving`, `t2va_orbital_airlock`, `t2va_pirate_deck_mutiny`, `t2va_police_interrogation`, `t2va_precinct_archive_vault`, `t2va_punk_basement_gig`, `t2va_rehearsal_room`, `t2va_restaurant_kitchen`, `t2va_safehouse_kitchen`, `t2va_steampunk_airship_bridge`, `t2va_studio_dancer`, `t2va_studio_dancer_close`, `t2va_subway_chase`, `t2va_subway_maintenance_alcove`, `t2va_trench_ww1_messenger`, `t2va_victorian_seance`, `i2va_kettle`, `i2va_vet_night`, `i2va_glassblower`, `i2va_night_market`, `i2va_lighthouse_keyframe`, `l2va_rescue_hut`, `l2va_bus_depot`, `l2va_laundromat`, `ref2va_continue_with_audio`, `ref2va_storyboard_bakery`, `ref2va_quarry_continuation`, `ref2va_radio_handover`, `ref2va_ballroom`, `ref2va_jacket_transfer`, `ref2va_observatory`, `ref2va_soundtrack_fully_copy`, `ref2va_diner_breakup_refs`, `ref2va_five_label`, `ref2va_scene_kitchen`, `ref2va_studio_dancer_close_refs` |
| `Pull Out` | `t2va_rooftop_pov`, `t2va_cartoon_vaudeville`, `t2va_delta_blues_porch`, `t2va_diner_breakup`, `t2va_diner_breakup_short`, `t2va_french_new_wave_cafe`, `t2va_hiphop_rooftop_cypher`, `t2va_kpop_dance_studio`, `t2va_marching_band`, `t2va_police_interrogation`, `t2va_sortline_long`, `t2va_sortline_short`, `fl2va_balloon`, `ref2va_quarry_continuation`, `ref2va_radio_handover`, `ref2va_bouldering_regrade`, `ref2va_diner_breakup_refs` |
| `Pan Left` | `t2va_french_new_wave_cafe`, `t2va_safehouse_kitchen`, `t2va_screwball_restaurant`, `t2va_sitcom_kitchen`, `t2va_silent_film`, `l2va_bus_depot` |
| `Pan Right` | `t2va_cartoon_vaudeville`, `t2va_kpop_dance_studio`, `t2va_nature_doc_arctic`, `fl2va_paper_train` |
| `Truck Left` | `t2va_covered_market`, `t2va_hardware_aisle_long`, `t2va_hardware_aisle_short`, `t2va_marching_band`, `t2va_motel_breezeway`, `t2va_orbital_airlock`, `t2va_parking_garage_pillar`, `t2va_police_interrogation`, `t2va_song_flicker_lists`, `i2va_vet_night`, `l2va_laundromat`, `ref2va_ballroom`, `ref2va_market_stallholder` |
| `Truck Right` | `t2va_cable_car`, `t2va_clinic_corridor`, `t2va_courtroom_verdict`, `t2va_cyber_hacker_den`, `t2va_newsroom_breaking`, `t2va_rail_dolly_long`, `t2va_rooftop_boiler_room`, `t2va_sortline_long`, `t2va_sortline_short`, `t2va_speakeasy_heist`, `t2va_trench_ww1_messenger`, `t2va_ww2_sub_sonar`, `fl2va_carousel`, `fl2va_interior_converge`, `l2va_interior_converge`, `ref2va_radio_handover`, `ref2va_soundtrack_fully_copy`, `ref2va_image_audio_music`, `ref2va_image_audio_voice`, `ref2va_image_ref_default`, `ref2va_image_video_audio_music`, `ref2va_image_video_structure`, `ref2va_role_character_environment`, `ref2va_role_character_garment_environment`, `ref2va_video_motion_transfer`, `ref2va_video_sound_structure`, `ref2va_video_structure_only` |
...
| `Arc Shot` | `t2va_cyberpunk_music_video`, `t2va_none_of_this_is_real_moving_camera`, `i2va_tattoo`, `ref2va_ballroom`, `ref2va_observatory` |
...
| `Static Shot` | `t2va_post_office`, `t2va_dancer_shot_floor`, `t2va_radio_drama`, `t2va_desert_crew`, `t2va_cable_car`, `t2va_appalachian_folk_cabin`, `t2va_cartoon_vaudeville`, `t2va_castle_rampart`, `t2va_cooking_show_meltdown`, `t2va_courtroom_verdict`, `t2va_covered_market`, `t2va_cyber_hacker_den`, `t2va_delta_blues_porch`, `t2va_diner_breakup`, `t2va_diner_breakup_short`, `t2va_disco_roller_rink`, `t2va_french_new_wave_cafe`, `t2va_frontier_standoff`, `t2va_gladiator_arena_tunnel`, `t2va_hardware_aisle_long`, `t2va_hardware_aisle_short`, `t2va_hiphop_rooftop_cypher`, `t2va_kpop_dance_studio`, `t2va_kungfu_tea_house`, `t2va_marching_band`, `t2va_medical_er_triage`, `t2va_nature_doc_arctic`, `t2va_newsroom_breaking`, `t2va_none_of_this_is_real`, `t2va_none_of_this_is_real_moving_subject`, `t2va_none_of_this_is_real_untold`, `t2va_opera_grand_stage`, `t2va_pirate_deck_mutiny`, `t2va_police_interrogation`, `t2va_precinct_archive_vault`, `t2va_punk_basement_gig`, `t2va_rooftop_boiler_room`, `t2va_samurai_bamboo_duel`, `t2va_screwball_restaurant`, `t2va_sitcom_kitchen`, `t2va_slapstick_moving_piano`, `t2va_song_flicker_lists`, `t2va_sortline_long`, `t2va_sortline_short`, `t2va_speakeasy_heist`, `t2va_steampunk_airship_bridge`, `t2va_studio_dancer`, `t2va_studio_dancer_close`, `t2va_subway_chase`, `t2va_victorian_seance`, `t2va_ww2_sub_sonar`, `t2va_silent_film`, `fl2va_origami_crane`, `l2va_telescope`, `l2va_kite_festival`, `ref2va_storyboard_bakery`, `ref2va_radio_handover`, `ref2va_jacket_transfer`, `ref2va_diner_breakup_refs`, `ref2va_five_label`, `ref2va_image_ref_default`, `ref2va_market_stallholder`, `ref2va_night_porter_refs`, `ref2va_studio_dancer_close_refs`, `ref2va_video_swap` |
| `Shake Slightly` | `t2va_diner_back_alley`, `t2va_diner_breakup_short`, `t2va_ferry_fog_deck`, `t2va_freight_elevator`, `t2va_hospital_fire_escape`, `t2va_motel_breezeway`, `t2va_parking_garage_pillar`, `t2va_pirate_deck_mutiny`, `t2va_punk_basement_gig`, `t2va_stairwell_dialogue`, `t2va_subway_maintenance_alcove`, `i2va_night_market`, `ref2va_bouldering_regrade`, `ref2va_stairwell_dialogue`, `ref2va_stairwell_dialogue_backstage`, `ref2va_stairwell_dialogue_circus` |
...
| value | prompts |
|---|---|
| `with small amplitude` | `t2va_noodle_bar`, `t2va_swimming_lesson`, `t2va_night_porter`, `t2va_dancer_shot_face`, `t2va_box_office`, `t2va_clay_apiary`, `t2va_dancer_stream_243`, `t2va_radio_drama`, `t2va_fireworks_barge`, `t2va_desert_crew`, `t2va_cable_car`, `t2va_appalachian_folk_cabin`, `t2va_arena_rock_video`, `t2va_cafe_kids`, `t2va_cartoon_vaudeville`, `t2va_castle_rampart`, `t2va_cooking_show_meltdown`, `t2va_courtroom_verdict`, `t2va_cyber_hacker_den`, `t2va_cyberpunk_music_video`, `t2va_delta_blues_porch`, `t2va_diner_back_alley`, `t2va_diner_breakup`, `t2va_diner_breakup_short`, `t2va_disco_roller_rink`, `t2va_ferry_fog_deck`, `t2va_freight_elevator`, `t2va_french_new_wave_cafe`, `t2va_frontier_standoff`, `t2va_gladiator_arena_tunnel`, `t2va_hardware_aisle_long`, `t2va_hardware_aisle_short`, `t2va_hiphop_rooftop_cypher`, `t2va_hospital_fire_escape`, `t2va_kpop_dance_studio`, `t2va_kungfu_tea_house`, `t2va_lighthouse`, `t2va_marching_band`, `t2va_medical_er_triage`, `t2va_motel_breezeway`, `t2va_nature_doc_arctic`, `t2va_newsroom_breaking`, `t2va_opera_grand_stage`, `t2va_orbital_airlock`, `t2va_parking_garage_pillar`, `t2va_pirate_deck_mutiny`, `t2va_police_interrogation`, `t2va_precinct_archive_vault`, `t2va_punk_basement_gig`, `t2va_rail_dolly_long`, `t2va_rehearsal_room`, `t2va_rooftop_boiler_room`, `t2va_safehouse_kitchen`, `t2va_samurai_bamboo_duel`, `t2va_screwball_restaurant`, `t2va_sitcom_kitchen`, `t2va_slapstick_moving_piano`, `t2va_song_flicker_lists`, `t2va_sortline_long`, `t2va_sortline_short`, `t2va_speakeasy_heist`, `t2va_steampunk_airship_bridge`, `t2va_subway_maintenance_alcove`, `t2va_trench_ww1_messenger`, `t2va_victorian_seance`, `t2va_ww2_sub_sonar`, `t2va_silent_film`, `i2va_kettle`, `i2va_tattoo`, `i2va_cargo_bay`, `i2va_vet_night`, `i2va_glassblower`, `i2va_night_market`, `i2va_lighthouse_keyframe`, `fl2va_paper_train`, `fl2va_potter_wheel`, `fl2va_balloon`, `fl2va_carousel`, `fl2va_interior_converge`, `l2va_chess_clock`, `l2va_rescue_hut`, `l2va_bus_depot`, `l2va_interior_converge`, `l2va_laundromat`, `ref2va_continue_with_audio`, `ref2va_storyboard_bakery`, `ref2va_quarry_continuation`, `ref2va_radio_handover`, `ref2va_bouldering_regrade`, `ref2va_ballroom`, `ref2va_jacket_transfer`, `ref2va_observatory`, `ref2va_soundtrack_fully_copy`, `ref2va_diner_breakup_refs`, `ref2va_five_label`, `ref2va_image_audio_music`, `ref2va_image_audio_voice`, `ref2va_image_video_audio_music`, `ref2va_image_video_structure`, `ref2va_night_porter_refs`, `ref2va_role_character_environment`, `ref2va_role_character_garment_environment`, `ref2va_scene_kitchen`, `ref2va_video_motion_transfer`, `ref2va_video_sound_structure`, `ref2va_video_structure_only` |
...
| `at slow speed` | `t2va_noodle_bar`, `t2va_swimming_lesson`, `t2va_night_porter`, `t2va_dancer_shot_face`, `t2va_box_office`, `t2va_clay_apiary`, `t2va_dancer_stream_243`, `t2va_radio_drama`, `t2va_fireworks_barge`, `t2va_desert_crew`, `t2va_cable_car`, `t2va_appalachian_folk_cabin`, `t2va_arena_rock_video`, `t2va_cafe_kids`, `t2va_cartoon_vaudeville`, `t2va_castle_rampart`, `t2va_cooking_show_meltdown`, `t2va_courtroom_verdict`, `t2va_cyber_hacker_den`, `t2va_cyberpunk_music_video`, `t2va_delta_blues_porch`, `t2va_diner_back_alley`, `t2va_diner_breakup`, `t2va_diner_breakup_short`, `t2va_disco_roller_rink`, `t2va_ferry_fog_deck`, `t2va_freight_elevator`, `t2va_french_new_wave_cafe`, `t2va_frontier_standoff`, `t2va_gladiator_arena_tunnel`, `t2va_hardware_aisle_long`, `t2va_hardware_aisle_short`, `t2va_hiphop_rooftop_cypher`, `t2va_hospital_fire_escape`, `t2va_kpop_dance_studio`, `t2va_kungfu_tea_house`, `t2va_lighthouse`, `t2va_marching_band`, `t2va_medical_er_triage`, `t2va_motel_breezeway`, `t2va_nature_doc_arctic`, `t2va_newsroom_breaking`, `t2va_none_of_this_is_real_moving_camera`, `t2va_opera_grand_stage`, `t2va_orbital_airlock`, `t2va_parking_garage_pillar`, `t2va_pirate_deck_mutiny`, `t2va_police_interrogation`, `t2va_precinct_archive_vault`, `t2va_rail_dolly_long`, `t2va_rehearsal_room`, `t2va_rooftop_boiler_room`, `t2va_safehouse_kitchen`, `t2va_samurai_bamboo_duel`, `t2va_screwball_restaurant`, `t2va_sitcom_kitchen`, `t2va_slapstick_moving_piano`, `t2va_song_flicker_lists`, `t2va_sortline_long`, `t2va_sortline_short`, `t2va_speakeasy_heist`, `t2va_steampunk_airship_bridge`, `t2va_subway_maintenance_alcove`, `t2va_trench_ww1_messenger`, `t2va_victorian_seance`, `t2va_ww2_sub_sonar`, `t2va_silent_film`, `i2va_kettle`, `i2va_tattoo`, `i2va_cargo_bay`, `i2va_vet_night`, `i2va_glassblower`, `i2va_night_market`, `i2va_lighthouse_keyframe`, `fl2va_paper_train`, `fl2va_potter_wheel`, `fl2va_balloon`, `fl2va_carousel`, `fl2va_interior_converge`, `fl2va_drawbridge`, `l2va_chess_clock`, `l2va_kite_festival`, `l2va_rescue_hut`, `l2va_bus_depot`, `l2va_interior_converge`, `l2va_laundromat`, `ref2va_continue_with_audio`, `ref2va_storyboard_bakery`, `ref2va_quarry_continuation`, `ref2va_radio_handover`, `ref2va_bouldering_regrade`, `ref2va_ballroom`, `ref2va_jacket_transfer`, `ref2va_observatory`, `ref2va_soundtrack_fully_copy`, `ref2va_diner_breakup_refs`, `ref2va_five_label`, `ref2va_image_audio_music`, `ref2va_image_audio_voice`, `ref2va_image_ref_default`, `ref2va_image_video_audio_music`, `ref2va_image_video_structure`, `ref2va_night_porter_refs`, `ref2va_role_character_environment`, `ref2va_role_character_garment_environment`, `ref2va_scene_kitchen`, `ref2va_video_motion_transfer`, `ref2va_video_sound_structure`, `ref2va_video_structure_only` |
| `at fast speed` | `t2va_rooftop_pov`, `t2va_arena_rock_video`, `t2va_cooking_show_meltdown`, `t2va_cyber_hacker_den`, `t2va_cyberpunk_music_video`, `t2va_diner_breakup_short`, `t2va_disco_roller_rink`, `t2va_kpop_dance_studio`, `t2va_kungfu_tea_house`, `t2va_medical_er_triage`, `t2va_pirate_deck_mutiny`, `t2va_punk_basement_gig`, `t2va_samurai_bamboo_duel`, `t2va_screwball_restaurant`, `t2va_sitcom_kitchen`, `t2va_slapstick_moving_piano`, `t2va_steampunk_airship_bridge`, `t2va_subway_chase`, `t2va_trench_ww1_messenger` |
...
| value | prompts |
|---|---|
| `the camera cuts to` | `t2va_clay_apiary`, `t2va_radio_drama`, `t2va_desert_crew`, `t2va_cable_car`, `t2va_appalachian_folk_cabin`, `t2va_castle_rampart`, `t2va_courtroom_verdict`, `t2va_cyber_hacker_den`, `t2va_cyberpunk_music_video`, `t2va_delta_blues_porch`, `t2va_diner_back_alley`, `t2va_diner_breakup`, `t2va_diner_breakup_short`, `t2va_disco_roller_rink`, `t2va_ferry_fog_deck`, `t2va_freight_elevator`, `t2va_french_new_wave_cafe`, `t2va_frontier_standoff`, `t2va_gladiator_arena_tunnel`, `t2va_hiphop_rooftop_cypher`, `t2va_hospital_fire_escape`, `t2va_kpop_dance_studio`, `t2va_kungfu_tea_house`, `t2va_marching_band`, `t2va_medical_er_triage`, `t2va_motel_breezeway`, `t2va_nature_doc_arctic`, `t2va_newsroom_breaking`, `t2va_opera_grand_stage`, `t2va_orbital_airlock`, `t2va_parking_garage_pillar`, `t2va_pirate_deck_mutiny`, `t2va_police_interrogation`, `t2va_precinct_archive_vault`, `t2va_rooftop_boiler_room`, `t2va_safehouse_kitchen`, `t2va_samurai_bamboo_duel`, `t2va_speakeasy_heist`, `t2va_stairwell_dialogue`, `t2va_steampunk_airship_bridge`, `t2va_subway_chase`, `t2va_subway_maintenance_alcove`, `t2va_trench_ww1_messenger`, `t2va_victorian_seance`, `t2va_ww2_sub_sonar`, `fl2va_carousel`, `l2va_bus_depot`, `l2va_laundromat`, `ref2va_diner_breakup_refs`, `ref2va_night_porter_refs`, `ref2va_stairwell_dialogue`, `ref2va_stairwell_dialogue_backstage`, `ref2va_stairwell_dialogue_circus` |
| `the shot cuts to` | `t2va_fireworks_barge`, `t2va_desert_crew`, `t2va_castle_rampart`, `t2va_clinic_corridor`, `t2va_courtroom_verdict`, `t2va_covered_market`, `t2va_cyber_hacker_den`, `t2va_diner_back_alley`, `t2va_diner_breakup`, `t2va_diner_breakup_short`, `t2va_disco_roller_rink`, `t2va_ferry_fog_deck`, `t2va_gladiator_arena_tunnel`, `t2va_hardware_aisle_long`, `t2va_hardware_aisle_short`, `t2va_hospital_fire_escape`, `t2va_lighthouse`, `t2va_orbital_airlock`, `t2va_parking_garage_pillar`, `t2va_pirate_deck_mutiny`, `t2va_police_interrogation`, `t2va_punk_basement_gig`, `t2va_rehearsal_room`, `t2va_restaurant_kitchen`, `t2va_rooftop_boiler_room`, `t2va_safehouse_kitchen`, `t2va_samurai_bamboo_duel`, `t2va_song_flicker_lists`, `t2va_sortline_long`, `t2va_sortline_short`, `t2va_speakeasy_heist`, `t2va_steampunk_airship_bridge`, `t2va_studio_dancer`, `t2va_studio_dancer_close`, `t2va_subway_chase`, `t2va_subway_platform`, `t2va_trench_ww1_messenger`, `t2va_victorian_seance`, `t2va_ww2_sub_sonar`, `i2va_vet_night`, `i2va_glassblower`, `ref2va_storyboard_bakery`, `ref2va_quarry_continuation`, `ref2va_radio_handover`, `ref2va_bouldering_regrade`, `ref2va_ballroom`, `ref2va_jacket_transfer`, `ref2va_observatory`, `ref2va_soundtrack_fully_copy`, `ref2va_diner_breakup_refs`, `ref2va_five_label`, `ref2va_market_stallholder`, `ref2va_scene_kitchen`, `ref2va_scene_subway`, `ref2va_studio_dancer_close_refs`, `ref2va_video_swap` |
| `the shot transitions to` | `t2va_rooftop_pov`, `t2va_arena_rock_video`, `t2va_cartoon_vaudeville`, `t2va_cooking_show_meltdown`, `t2va_french_new_wave_cafe`, `t2va_hiphop_rooftop_cypher`, `t2va_motel_breezeway`, `t2va_opera_grand_stage`, `t2va_screwball_restaurant`, `t2va_sitcom_kitchen`, `t2va_slapstick_moving_piano`, `l2va_kite_festival` |
...
| `wipe` | `t2va_covered_market`, `t2va_diner_breakup_short`, `t2va_french_new_wave_cafe`, `t2va_safehouse_kitchen`, `t2va_trench_ww1_messenger`, `i2va_tattoo`, `ref2va_market_stallholder` |
...
| value | prompts |
|---|---|
| `Cinematic` | `t2va_noodle_bar`, `t2va_night_porter`, `t2va_dancer_shot_face`, `t2va_dancer_shot_floor`, `t2va_rooftop_pov`, `t2va_dancer_stream_243`, `t2va_radio_drama`, `t2va_appalachian_folk_cabin`, `t2va_cafe_kids`, `t2va_castle_rampart`, `t2va_clinic_corridor`, `t2va_courtroom_verdict`, `t2va_covered_market`, `t2va_crowd_churn_long`, `t2va_cyberpunk_music_video`, `t2va_delta_blues_porch`, `t2va_diner_back_alley`, `t2va_diner_breakup`, `t2va_diner_breakup_short`, `t2va_ferry_fog_deck`, `t2va_freight_elevator`, `t2va_frontier_standoff`, `t2va_gladiator_arena_tunnel`, `t2va_hardware_aisle_long`, `t2va_hardware_aisle_short`, `t2va_hospital_fire_escape`, `t2va_kpop_dance_studio`, `t2va_lighthouse`, `t2va_marching_band`, `t2va_motel_breezeway`, `t2va_none_of_this_is_real`, `t2va_none_of_this_is_real_moving`, `t2va_none_of_this_is_real_moving_camera`, `t2va_none_of_this_is_real_moving_subject`, `t2va_none_of_this_is_real_untold`, `t2va_opera_grand_stage`, `t2va_orbital_airlock`, `t2va_parking_garage_pillar`, `t2va_pirate_deck_mutiny`, `t2va_police_interrogation`, `t2va_precinct_archive_vault`, `t2va_rail_dolly_long`, `t2va_rehearsal_room`, `t2va_restaurant_kitchen`, `t2va_rooftop_boiler_room`, `t2va_safehouse_kitchen`, `t2va_samurai_bamboo_duel`, `t2va_song_flicker_lists`, `t2va_sortline_long`, `t2va_sortline_short`, `t2va_speakeasy_heist`, `t2va_stairwell_dialogue`, `t2va_steampunk_airship_bridge`, `t2va_studio_dancer`, `t2va_studio_dancer_close`, `t2va_subway_chase`, `t2va_subway_maintenance_alcove`, `t2va_subway_platform`, `t2va_trench_ww1_messenger`, `t2va_victorian_seance`, `t2va_ww2_sub_sonar`, `i2va_kettle`, `i2va_vet_night`, `i2va_night_market`, `i2va_lighthouse_keyframe`, `fl2va_origami_crane`, `fl2va_carousel`, `fl2va_interior_converge`, `fl2va_drawbridge`, `l2va_chess_clock`, `l2va_rescue_hut`, `l2va_bus_depot`, `l2va_interior_converge`, `ref2va_ballroom`, `ref2va_diner_breakup_refs`, `ref2va_image_audio_music`, `ref2va_image_audio_voice`, `ref2va_image_ref_default`, `ref2va_image_video_audio_music`, `ref2va_image_video_structure`, `ref2va_market_stallholder`, `ref2va_night_porter_refs`, `ref2va_role_character_environment`, `ref2va_role_character_garment_environment`, `ref2va_scene_kitchen`, `ref2va_scene_subway`, `ref2va_studio_dancer_close_refs`, `ref2va_video_character_swap`, `ref2va_video_continuation`, `ref2va_video_garment_edit`, `ref2va_video_image_edit`, `ref2va_video_motion_transfer`, `ref2va_video_sound_structure`, `ref2va_video_structure_only` |
| `live-action` | `t2va_noodle_bar`, `t2va_swimming_lesson`, `t2va_night_porter`, `t2va_dancer_shot_face`, `t2va_dancer_shot_floor`, `t2va_rooftop_pov`, `t2va_dancer_stream_243`, `t2va_radio_drama`, `t2va_desert_crew`, `t2va_appalachian_folk_cabin`, `t2va_arena_rock_video`, `t2va_cafe_kids`, `t2va_castle_rampart`, `t2va_clinic_corridor`, `t2va_cooking_show_meltdown`, `t2va_courtroom_verdict`, `t2va_covered_market`, `t2va_crowd_churn_long`, `t2va_cyber_hacker_den`, `t2va_cyberpunk_music_video`, `t2va_delta_blues_porch`, `t2va_diner_back_alley`, `t2va_diner_breakup`, `t2va_disco_roller_rink`, `t2va_ferry_fog_deck`, `t2va_freight_elevator`, `t2va_french_new_wave_cafe`, `t2va_frontier_standoff`, `t2va_gladiator_arena_tunnel`, `t2va_hardware_aisle_long`, `t2va_hardware_aisle_short`, `t2va_hiphop_rooftop_cypher`, `t2va_hospital_fire_escape`, `t2va_kpop_dance_studio`, `t2va_kungfu_tea_house`, `t2va_lighthouse`, `t2va_marching_band`, `t2va_medical_er_triage`, `t2va_motel_breezeway`, `t2va_nature_doc_arctic`, `t2va_newsroom_breaking`, `t2va_none_of_this_is_real`, `t2va_none_of_this_is_real_moving`, `t2va_none_of_this_is_real_moving_camera`, `t2va_none_of_this_is_real_moving_subject`, `t2va_none_of_this_is_real_untold`, `t2va_opera_grand_stage`, `t2va_orbital_airlock`, `t2va_parking_garage_pillar`, `t2va_pirate_deck_mutiny`, `t2va_police_interrogation`, `t2va_precinct_archive_vault`, `t2va_punk_basement_gig`, `t2va_rail_dolly_long`, `t2va_rehearsal_room`, `t2va_restaurant_kitchen`, `t2va_rooftop_boiler_room`, `t2va_safehouse_kitchen`, `t2va_samurai_bamboo_duel`, `t2va_screwball_restaurant`, `t2va_sitcom_kitchen`, `t2va_slapstick_moving_piano`, `t2va_song_flicker_lists`, `t2va_sortline_long`, `t2va_sortline_short`, `t2va_speakeasy_heist`, `t2va_stairwell_dialogue`, `t2va_steampunk_airship_bridge`, `t2va_studio_dancer`, `t2va_studio_dancer_close`, `t2va_subway_chase`, `t2va_subway_maintenance_alcove`, `t2va_subway_platform`, `t2va_trench_ww1_messenger`, `t2va_victorian_seance`, `t2va_ww2_sub_sonar`, `i2va_kettle`, `i2va_tattoo`, `i2va_vet_night`, `i2va_glassblower`, `i2va_night_market`, `i2va_lighthouse_keyframe`, `fl2va_origami_crane`, `fl2va_potter_wheel`, `fl2va_carousel`, `fl2va_interior_converge`, `fl2va_drawbridge`, `l2va_telescope`, `l2va_chess_clock`, `l2va_rescue_hut`, `l2va_bus_depot`, `l2va_interior_converge`, `l2va_laundromat`, `ref2va_continue_with_audio`, `ref2va_storyboard_bakery`, `ref2va_quarry_continuation`, `ref2va_radio_handover`, `ref2va_bouldering_regrade`, `ref2va_ballroom`, `ref2va_jacket_transfer`, `ref2va_observatory`, `ref2va_soundtrack_fully_copy`, `ref2va_diner_breakup_refs`, `ref2va_five_label`, `ref2va_image_audio_music`, `ref2va_image_audio_voice`, `ref2va_image_ref_default`, `ref2va_image_video_audio_music`, `ref2va_image_video_structure`, `ref2va_market_stallholder`, `ref2va_night_porter_refs`, `ref2va_role_character_environment`, `ref2va_role_character_garment_environment`, `ref2va_scene_kitchen`, `ref2va_scene_subway`, `ref2va_stairwell_dialogue`, `ref2va_stairwell_dialogue_backstage`, `ref2va_studio_dancer_close_refs`, `ref2va_video_character_swap`, `ref2va_video_continuation`, `ref2va_video_garment_edit`, `ref2va_video_image_edit`, `ref2va_video_motion_transfer`, `ref2va_video_sound_structure`, `ref2va_video_structure_only`, `ref2va_video_swap` |
...
| `English` | `t2va_night_porter`, `t2va_rooftop_pov`, `t2va_box_office`, `t2va_clay_apiary`, `t2va_radio_drama`, `t2va_desert_crew`, `t2va_cable_car`, `t2va_appalachian_folk_cabin`, `t2va_arena_rock_video`, `t2va_cafe_kids`, `t2va_cartoon_vaudeville`, `t2va_castle_rampart`, `t2va_clinic_corridor`, `t2va_cooking_show_meltdown`, `t2va_courtroom_verdict`, `t2va_covered_market`, `t2va_cyber_hacker_den`, `t2va_cyberpunk_music_video`, `t2va_delta_blues_porch`, `t2va_diner_back_alley`, `t2va_diner_breakup`, `t2va_diner_breakup_short`, `t2va_disco_roller_rink`, `t2va_ferry_fog_deck`, `t2va_freight_elevator`, `t2va_frontier_standoff`, `t2va_hardware_aisle_long`, `t2va_hardware_aisle_short`, `t2va_hiphop_rooftop_cypher`, `t2va_hospital_fire_escape`, `t2va_kpop_dance_studio`, `t2va_marching_band`, `t2va_medical_er_triage`, `t2va_motel_breezeway`, `t2va_nature_doc_arctic`, `t2va_newsroom_breaking`, `t2va_none_of_this_is_real`, `t2va_none_of_this_is_real_moving`, `t2va_none_of_this_is_real_moving_camera`, `t2va_none_of_this_is_real_moving_subject`, `t2va_orbital_airlock`, `t2va_parking_garage_pillar`, `t2va_pirate_deck_mutiny`, `t2va_police_interrogation`, `t2va_precinct_archive_vault`, `t2va_punk_basement_gig`, `t2va_rehearsal_room`, `t2va_restaurant_kitchen`, `t2va_rooftop_boiler_room`, `t2va_safehouse_kitchen`, `t2va_screwball_restaurant`, `t2va_sitcom_kitchen`, `t2va_slapstick_moving_piano`, `t2va_sortline_long`, `t2va_sortline_short`, `t2va_speakeasy_heist`, `t2va_stairwell_dialogue`, `t2va_steampunk_airship_bridge`, `t2va_subway_chase`, `t2va_subway_maintenance_alcove`, `t2va_subway_platform`, `t2va_trench_ww1_messenger`, `t2va_victorian_seance`, `t2va_ww2_sub_sonar`, `i2va_tattoo`, `i2va_vet_night`, `i2va_night_market`, `fl2va_potter_wheel`, `fl2va_carousel`, `l2va_chess_clock`, `l2va_kite_festival`, `l2va_rescue_hut`, `l2va_bus_depot`, `l2va_laundromat`, `ref2va_storyboard_bakery`, `ref2va_radio_handover`, `ref2va_ballroom`, `ref2va_observatory`, `ref2va_soundtrack_fully_copy`, `ref2va_diner_breakup_refs`, `ref2va_five_label`, `ref2va_image_audio_voice`, `ref2va_market_stallholder`, `ref2va_night_porter_refs`, `ref2va_scene_kitchen`, `ref2va_scene_subway`, `ref2va_stairwell_dialogue`, `ref2va_stairwell_dialogue_backstage`, `ref2va_stairwell_dialogue_circus`, `ref2va_video_swap` |
...
| `reference generation` | `ref2va_storyboard_bakery`, `ref2va_radio_handover`, `ref2va_ballroom`, `ref2va_jacket_transfer`, `ref2va_observatory`, `ref2va_soundtrack_fully_copy`, `ref2va_diner_breakup_refs`, `ref2va_five_label`, `ref2va_image_audio_music`, `ref2va_image_audio_voice`, `ref2va_image_ref_default`, `ref2va_image_video_audio_music`, `ref2va_image_video_structure`, `ref2va_market_stallholder`, `ref2va_night_porter_refs`, `ref2va_role_character_environment`, `ref2va_role_character_garment_environment`, `ref2va_scene_kitchen`, `ref2va_scene_subway`, `ref2va_stairwell_dialogue`, `ref2va_stairwell_dialogue_backstage`, `ref2va_stairwell_dialogue_circus`, `ref2va_studio_dancer_close_refs`, `ref2va_video_character_swap`, `ref2va_video_image_edit`, `ref2va_video_motion_transfer`, `ref2va_video_sound_structure`, `ref2va_video_structure_only` |
...
| value | prompts |
|---|---|
| `fully_preserved` | `ref2va_continue_with_audio`, `ref2va_storyboard_bakery`, `ref2va_quarry_continuation`, `ref2va_radio_handover`, `ref2va_bouldering_regrade`, `ref2va_ballroom`, `ref2va_jacket_transfer`, `ref2va_observatory`, `ref2va_soundtrack_fully_copy`, `ref2va_diner_breakup_refs`, `ref2va_five_label`, `ref2va_image_audio_music`, `ref2va_image_audio_voice`, `ref2va_image_ref_default`, `ref2va_image_video_audio_music`, `ref2va_image_video_structure`, `ref2va_market_stallholder`, `ref2va_night_porter_refs`, `ref2va_role_character_environment`, `ref2va_role_character_garment_environment`, `ref2va_scene_kitchen`, `ref2va_scene_subway`, `ref2va_stairwell_dialogue`, `ref2va_stairwell_dialogue_backstage`, `ref2va_stairwell_dialogue_circus`, `ref2va_studio_dancer_close_refs`, `ref2va_video_character_swap`, `ref2va_video_continuation`, `ref2va_video_image_edit`, `ref2va_video_motion_transfer`, `ref2va_video_sound_structure`, `ref2va_video_structure_only`, `ref2va_video_swap` |
...
| value | prompts |
|---|---|
| `<d>` | `t2va_noodle_bar`, `t2va_swimming_lesson`, `t2va_night_porter`, `t2va_rooftop_pov`, `t2va_box_office`, `t2va_clay_apiary`, `t2va_radio_drama`, `t2va_fireworks_barge`, `t2va_desert_crew`, `t2va_cable_car`, `t2va_appalachian_folk_cabin`, `t2va_arena_rock_video`, `t2va_cafe_kids`, `t2va_cartoon_vaudeville`, `t2va_castle_rampart`, `t2va_clinic_corridor`, `t2va_cooking_show_meltdown`, `t2va_courtroom_verdict`, `t2va_covered_market`, `t2va_cyber_hacker_den`, `t2va_cyberpunk_music_video`, `t2va_delta_blues_porch`, `t2va_diner_back_alley`, `t2va_diner_breakup`, `t2va_diner_breakup_short`, `t2va_disco_roller_rink`, `t2va_ferry_fog_deck`, `t2va_freight_elevator`, `t2va_french_new_wave_cafe`, `t2va_frontier_standoff`, `t2va_gladiator_arena_tunnel`, `t2va_hardware_aisle_long`, `t2va_hardware_aisle_short`, `t2va_hiphop_rooftop_cypher`, `t2va_hospital_fire_escape`, `t2va_kpop_dance_studio`, `t2va_kungfu_tea_house`, `t2va_marching_band`, `t2va_medical_er_triage`, `t2va_motel_breezeway`, `t2va_nature_doc_arctic`, `t2va_newsroom_breaking`, `t2va_none_of_this_is_real`, `t2va_none_of_this_is_real_moving`, `t2va_none_of_this_is_real_moving_camera`, `t2va_none_of_this_is_real_moving_subject`, `t2va_opera_grand_stage`, `t2va_orbital_airlock`, `t2va_parking_garage_pillar`, `t2va_pirate_deck_mutiny`, `t2va_police_interrogation`, `t2va_precinct_archive_vault`, `t2va_punk_basement_gig`, `t2va_rehearsal_room`, `t2va_restaurant_kitchen`, `t2va_rooftop_boiler_room`, `t2va_safehouse_kitchen`, `t2va_samurai_bamboo_duel`, `t2va_screwball_restaurant`, `t2va_sitcom_kitchen`, `t2va_slapstick_moving_piano`, `t2va_sortline_long`, `t2va_sortline_short`, `t2va_speakeasy_heist`, `t2va_stairwell_dialogue`, `t2va_steampunk_airship_bridge`, `t2va_subway_chase`, `t2va_subway_maintenance_alcove`, `t2va_subway_platform`, `t2va_trench_ww1_messenger`, `t2va_victorian_seance`, `t2va_ww2_sub_sonar`, `i2va_tattoo`, `i2va_vet_night`, `i2va_glassblower`, `i2va_night_market`, `fl2va_potter_wheel`, `fl2va_carousel`, `l2va_chess_clock`, `l2va_kite_festival`, `l2va_rescue_hut`, `l2va_bus_depot`, `l2va_laundromat`, `ref2va_continue_with_audio`, `ref2va_storyboard_bakery`, `ref2va_radio_handover`, `ref2va_ballroom`, `ref2va_jacket_transfer`, `ref2va_observatory`, `ref2va_soundtrack_fully_copy`, `ref2va_diner_breakup_refs`, `ref2va_five_label`, `ref2va_image_audio_voice`, `ref2va_market_stallholder`, `ref2va_night_porter_refs`, `ref2va_scene_kitchen`, `ref2va_scene_subway`, `ref2va_stairwell_dialogue`, `ref2va_stairwell_dialogue_backstage`, `ref2va_stairwell_dialogue_circus`, `ref2va_video_swap` |
...
| shape | prompts |
|---|---|
| no speaker | `t2va_post_office`, `t2va_dancer_shot_face`, `t2va_dancer_shot_floor`, `t2va_dancer_stream_243`, `t2va_crowd_churn_long`, `t2va_lighthouse`, `t2va_rail_dolly_long`, `t2va_studio_dancer`, `t2va_studio_dancer_close`, `t2va_silent_film`, `i2va_kettle`, `i2va_cargo_bay`, `i2va_lighthouse_keyframe`, `fl2va_origami_crane`, `fl2va_paper_train`, `fl2va_balloon`, `fl2va_interior_converge`, `fl2va_drawbridge`, `l2va_telescope`, `l2va_interior_converge`, `ref2va_quarry_continuation`, `ref2va_bouldering_regrade`, `ref2va_soundtrack_fully_copy`, `ref2va_image_audio_music`, `ref2va_image_ref_default`, `ref2va_image_video_audio_music`, `ref2va_image_video_structure`, `ref2va_role_character_environment`, `ref2va_role_character_garment_environment`, `ref2va_studio_dancer_close_refs`, `ref2va_video_character_swap`, `ref2va_video_continuation`, `ref2va_video_garment_edit`, `ref2va_video_image_edit`, `ref2va_video_motion_transfer`, `ref2va_video_sound_structure`, `ref2va_video_structure_only` |
| one speaker | `t2va_noodle_bar`, `t2va_swimming_lesson`, `t2va_night_porter`, `t2va_rooftop_pov`, `t2va_cable_car`, `t2va_appalachian_folk_cabin`, `t2va_arena_rock_video`, `t2va_cartoon_vaudeville`, `t2va_cooking_show_meltdown`, `t2va_cyber_hacker_den`, `t2va_cyberpunk_music_video`, `t2va_delta_blues_porch`, `t2va_disco_roller_rink`, `t2va_hiphop_rooftop_cypher`, `t2va_kpop_dance_studio`, `t2va_marching_band`, `t2va_nature_doc_arctic`, `t2va_none_of_this_is_real`, `t2va_none_of_this_is_real_moving`, `t2va_none_of_this_is_real_moving_camera`, `t2va_none_of_this_is_real_moving_subject`, `t2va_none_of_this_is_real_untold`, `t2va_opera_grand_stage`, `t2va_punk_basement_gig`, `t2va_song_flicker_lists`, `t2va_subway_chase`, `i2va_tattoo`, `i2va_vet_night`, `i2va_glassblower`, `fl2va_potter_wheel`, `fl2va_carousel`, `l2va_kite_festival`, `l2va_rescue_hut`, `ref2va_continue_with_audio`, `ref2va_storyboard_bakery`, `ref2va_jacket_transfer`, `ref2va_image_audio_voice`, `ref2va_night_porter_refs`, `ref2va_scene_kitchen`, `ref2va_video_swap` |
| two speakers | `t2va_box_office`, `t2va_clay_apiary`, `t2va_fireworks_barge`, `t2va_desert_crew`, `t2va_cafe_kids`, `t2va_castle_rampart`, `t2va_clinic_corridor`, `t2va_courtroom_verdict`, `t2va_covered_market`, `t2va_diner_back_alley`, `t2va_diner_breakup`, `t2va_diner_breakup_short`, `t2va_ferry_fog_deck`, `t2va_freight_elevator`, `t2va_french_new_wave_cafe`, `t2va_frontier_standoff`, `t2va_gladiator_arena_tunnel`, `t2va_hardware_aisle_long`, `t2va_hardware_aisle_short`, `t2va_hospital_fire_escape`, `t2va_kungfu_tea_house`, `t2va_medical_er_triage`, `t2va_motel_breezeway`, `t2va_newsroom_breaking`, `t2va_orbital_airlock`, `t2va_parking_garage_pillar`, `t2va_pirate_deck_mutiny`, `t2va_police_interrogation`, `t2va_precinct_archive_vault`, `t2va_rehearsal_room`, `t2va_restaurant_kitchen`, `t2va_rooftop_boiler_room`, `t2va_safehouse_kitchen`, `t2va_samurai_bamboo_duel`, `t2va_screwball_restaurant`, `t2va_sitcom_kitchen`, `t2va_slapstick_moving_piano`, `t2va_sortline_long`, `t2va_sortline_short`, `t2va_speakeasy_heist`, `t2va_stairwell_dialogue`, `t2va_steampunk_airship_bridge`, `t2va_subway_maintenance_alcove`, `t2va_trench_ww1_messenger`, `t2va_victorian_seance`, `t2va_ww2_sub_sonar`, `i2va_night_market`, `l2va_chess_clock`, `l2va_bus_depot`, `l2va_laundromat`, `ref2va_radio_handover`, `ref2va_ballroom`, `ref2va_observatory`, `ref2va_diner_breakup_refs`, `ref2va_five_label`, `ref2va_market_stallholder`, `ref2va_scene_subway`, `ref2va_stairwell_dialogue`, `ref2va_stairwell_dialogue_backstage`, `ref2va_stairwell_dialogue_circus` |
...
```
python bench/grade_prompt_text.py --mode t2va --length 192 prompt_bank/t2va_dancer_shot_face.txt
  0 FAIL, 0 WARN
```
...
```
python bench/grade_prompt_text.py --mode t2va --length 192 prompt_bank/t2va_dancer_shot_floor.txt
  0 FAIL, 0 WARN
```
...
## t2va_dancer_stream_243

**t2va, 243 frames, 10.125 s.** The studio dancer as one continuous ten-second medium shot pushing in, no cut, for the TaoMate streaming runtime's two-request length (docs/h3_taomate.md section 7); written for a frozen drum-machine track. **Tests:** whether one person stays one person across a streamed chunk and request boundary: identity, body count and the face under a slow push-in, with the moves on the beat of the frozen track. The TaoMate whole-clip render of the dancer split her into two people.

Derived: camera: Push In; 157 words in the main field; 1138 characters in all.

```
python bench/grade_prompt_text.py --mode t2va --length 243 prompt_bank/t2va_dancer_stream_243.txt
  0 FAIL, 0 WARN
```

```text
integrated_multimodal_description: [Shot 1] Live-action, cinematic, a medium shot frames a lone dancer from the knees up in a bright rehearsal studio across the ten-second take, a mirrored wall behind her and a portable speaker on the sprung wooden floor at the edge of frame playing a fast, dry drum-machine pulse. She is in her twenties, with dark hair tied back, in a grey vest and loose black trousers, barefoot, and she produces no vocal sound. She dances alone to the pulse: sharp shoulder isolations on every beat, a quick head snap on the downbeats, arms cutting out and folding back in, and on the fourth hit of each bar a small hop that lands square before the pattern starts again. Her face stays calm and focused, her eyes on her own reflection. The camera pushes in with small amplitude at slow speed until her head and shoulders fill the frame, and it does not pan, tilt or cut.

overall_soundscape: Bare feet squeak and slap on the sprung floor, fabric swings and rustles with each isolation, and her breath comes in short controlled bursts between hits, under the dry room tone of an empty studio.
...
**t2va, 345 frames, 14.375 s.** An outside prompt rewritten into the house structure at the owner's request (2026-09-15): four children at a golden-hour diner table, two short lines, the background couple and waitress silent, a slow push-in, one shot. Rendered beside the verbatim original on PDD at 5 and 8 steps. **Tests:** whether the house structure changes a dense, many-object scene against the same content written as a paragraph: four distinct children and their props, background figures, readable handheld screen, window street, and two lines owned by the right speakers.

Derived: camera: Push In; speakers: S1, S2; languages: English; 296 words in the main field; 2130 characters in all.

```
python bench/grade_prompt_text.py --mode t2va --length 345 prompt_bank/t2va_cafe_kids.txt
  0 FAIL, 0 WARN
```

```text
integrated_multimodal_description: [Shot 1] Live-action, cinematic, golden hour, a medium-wide shot frames four children around a table by the front windows of a busy cafe diner across the fourteen-second take, a plate of hamburgers and french fries in front of each of them. A red-haired boy, on-screen, about ten, with a bright, excited treble (S1), holds a steaming mug of hot chocolate in both hands. A brunette girl, on-screen, about nine, draws with crayons on a paper towel and produces no vocal sound. A blond boy, on-screen, about ten, hunches over a purple Game Boy Advance with Sonic the Hedgehog running across its small screen and produces no vocal sound. An Asian girl, on-screen, about nine, with a soft, amused voice (S2), sips through a straw from a glass soda bottle. Behind them on the left, a man and a woman sit at a small table eating scones and drinking coffee and produce no vocal sound; on the right, a waitress stands behind the checkout counter beside an antique brass cash register, writing on a notepad, and produces no vocal sound. Through the clear glass windows on the left, a historic downtown street glows with shop awnings and gilt lettering on the display windows, the warm light of the shops set against a rosy sky and dark, shady trees. The red-haired boy (S1) sets down his mug, turns toward the girl with the soda bottle, and says: <d>[English] He's going to lose that race again.</d> His lips close into a grin. The girl (S2) lowers the bottle, glances at the blond boy's screen, and answers: <d>[English] No, he's winning this time.</d> Her lips close as she smiles. The camera pushes in with small amplitude at slow speed toward the table, and it does not pan, tilt or cut.

overall_soundscape: A warm cafe room tone with low, indistinct adult conversation, cutlery clinking on plates, the quick electronic beeps of the handheld game, crayons scratching on paper, a straw gurgling at the bottom of the soda bottle, and the soft ring of the cash register drawer.

non_diegetic_music: A gentle, warm acoustic guitar and light piano melody at a relaxed tempo that stays low under the scene.
```
...
## t2va_diner_back_alley

**t2va, 345 frames, 14.375 s.** Live-action handheld 35mm; estranged brothers confrontation in rainswept diner back alley, three shots with cuts, S1/S2 tags; N/A. **Tests:** Commercial exhaust fan and wet alley soundscape, push in and shake slightly, off-screen dialogue response.

Derived: camera: Push In, Shake Slightly; speakers: S1, S2; languages: English; cuts: the camera cuts to, the shot cuts to; 179 words in the main field; 1377 characters in all.

```
python bench/grade_prompt_text.py --mode t2va --length 345 prompt_bank/t2va_diner_back_alley.txt
  0 FAIL, 0 WARN
```

```text
integrated_multimodal_description: [Shot 1] Live-action, cinematic, handheld on 35mm, a medium two-shot frames an estranged brother in a wet leather jacket confronting a cook in a white apron outside a diner back door, rain falling through the red glow of an overhead neon sign. The brother with the edgy hoarse tenor (S1) says, <d>[English] They know you took the forty grand.</d> The cook produces no vocal sound, arms folded across his apron. The camera pushes in with small amplitude at slow speed along the brick wall. [Shot 2] At 00:05.600, the camera cuts to a close-up of the brother, neon light gleaming on his wet leather collar. He (S1) says, <d>[English] Two collectors are at your house.</d> The camera shakes slightly with his agitated posture. [Shot 3] At 00:10.800, the shot cuts to a close-up of the cook framed in the open kitchen doorway, exhaust fan whirring behind him. The cook with the tired level baritone (S2) says, <d>[English] Call the precinct.</d> He steps back over the threshold, pulls the heavy metal door shut, and holds still until the final frame.

overall_soundscape: Steady rain spatters on wet asphalt and clatters against metal dumpster lids under the hollow whine of a commercial exhaust fan. Water gurgles down a rusted drainpipe, wet boot leather squeaks on brick, and a metal screen door creaks on its spring.
...
**t2va, 345 frames, 14.375 s.** The owner's diner reveal (2026-09-15): 'I'm pregnant!', the coffee thrown across a cut into his face, his stammered reply, and her walk-out past a frozen silent cook; 4 shots; push in, shake slightly, static shot, pull out; a hard orchestral sting. The id predates the owner's request the same day to extend the text to fill the take. **Tests:** fast physical action with liquid across a cut (throw, splash, drip), shouted lines and a scream owned by the right speaker, and a wide walk-out with a background character who stays silent. High motion, unlike t2va_diner_breakup, so it shows morphing and cloning where that one cannot.

Derived: camera: Push In, Pull Out, Static Shot, Shake Slightly; speakers: S1, S2; languages: English; cuts: the camera cuts to, the shot cuts to; 455 words in the main field; 3710 characters in all.

```
python bench/grade_prompt_text.py --mode t2va --length 345 prompt_bank/t2va_diner_breakup_short.txt
  0 FAIL, 0 WARN
```

```text
integrated_multimodal_description: [Shot 1] Cinematic, a medium close-up opens the fourteen-second take, the camera pushes in with small amplitude at fast speed on a young woman in a pastel pink cardigan and a silver hairpin, on-screen, twenties, with a sharp, trembling soprano and an explosive delivery (S1). She sits at a formica table in a 1950s roadside diner booth, illuminated by a moody blue-and-ruby neon glow bleeding through a rain-spattered exterior window in the background. A heavy ceramic mug of dark coffee steams in the foreground. The young woman (S1) glares forward with tear-streaked fury, her chest heaving, and shouts, <d>[English] I'm pregnant!</d> Her lips press shut as her face contorts in rage, and she grabs the ceramic mug with her right hand and violently hurls the steaming black coffee directly toward the right side of the frame. [Shot 2] At 00:02.500, the shot cuts to a medium shot from a slightly high angle framing a young greaser in a cuffed denim jacket with slicked-back pompadour hair, on-screen, twenties, with a panicked, guttural yell (S2). The steaming dark coffee violently splashes directly across his face and neck. The young man (S2) recoils hard against the red vinyl backrest, squeezing his eyes shut as the hot liquid drips from his nose and chin, and screams, <d>[English] Aaagh!</d> His mouth snaps shut and his jaw stops moving. The camera shakes slightly as he frantically wipes his dripping face with both hands, his shoulders hunching in painful defense. [Shot 3] At 00:06.200, the camera cuts to a close-up of the young man (S2), coffee still running off his pompadour onto his collar. He lowers his hands, blinks the liquid from his lashes, and stares across the table at the young woman in the pink cardigan, his voice cracking as he stammers, <d>[English] Pregnant? Are you sure?</d> His lips fall open and then close slowly as his jaw goes slack. The camera holds a static shot on his stunned, dripping face. [Shot 4] At 00:10.100, the shot cuts to a wide shot down the length of the diner, framing the booth in the foreground and the long chrome counter behind it, where a heavyset short-order cook in a paper soda jerk hat, on-screen, fifties, freezes with a spatula raised over the griddle and produces no vocal sound. The young woman (S1) slides out of the booth, snatches her purse, turns toward the young man in the denim jacket, and spits, <d>[English] Congratulations, daddy.</d> Her lips close tightly as she spins on her heel and strides toward the glass door, while the young man (S2) sits frozen in the booth and makes no sound. The camera pulls out with small amplitude at slow speed as the door swings open onto the rain.

overall_soundscape: A low diner room tone and the steady patter of rain against glass are abruptly pierced by a loud, furious female shout. This is immediately followed by the sharp scrape of ceramic on formica, a pronounced liquid swoosh, and a loud, wet splat as hot coffee makes heavy impact, transitioning into panicked male screams and frantic fabric rustling as hands wipe wet skin. Coffee drips steadily onto the vinyl seat and the formica tabletop, and the griddle keeps hissing in the quiet. Vinyl squeaks as she slides out of the booth, her heels click quickly across the checkered floor, a small brass bell above the door jingles, and the rain swells louder as the door swings open.

non_diegetic_music: A sudden, dissonant orchestral strike featuring a sharp, high-pitched violin stab and a loud, booming bass drum hit that quickly decays into tense, ringing silence, then a low, trembling string tremolo creeps back in as she stands and rises into a single sharp pizzicato pluck as the door opens.
```
...
**t2va, 345 frames, 14.375 s.** Live-action handheld 35mm; corporate auditor and executive dialogue at night commuter ferry stern rail, three shots with cuts, S1/S2 tags; N/A. **Tests:** Foggy harbor marine diesel soundscape, push in and shake slightly, lines spoken on- and off-screen.

Derived: camera: Push In, Shake Slightly; speakers: S1, S2; languages: English; cuts: the camera cuts to, the shot cuts to; 193 words in the main field; 1488 characters in all.

```
python bench/grade_prompt_text.py --mode t2va --length 345 prompt_bank/t2va_ferry_fog_deck.txt
  0 FAIL, 0 WARN
```

```text
integrated_multimodal_description: [Shot 1] Live-action, cinematic, handheld on 35mm, a medium two-shot frames a corporate auditor in a charcoal cashmere coat facing a former executive in a navy trench coat at the stern rail of a night commuter ferry, deck lamps throwing hazy halos through heavy harbor fog. The auditor with the crisp low contralto (S1) says, <d>[English] The grand jury froze all corporate accounts.</d> The executive produces no vocal sound, gripping the cold metal rail. Her jaw tightens and the camera pushes in with small amplitude at slow speed toward the churned wake. [Shot 2] At 00:05.800, the shot cuts to a close-up of the auditor against dripping steel plating, fog swirling past her face. She (S1) says, <d>[English] The subpoena was signed this afternoon.</d> The camera shakes slightly with the vibration of the ferry deck. [Shot 3] At 00:11.000, the camera cuts to a close shot of the executive gripping the painted railing, dark sea spray misting his hair. The executive with the hollow gravelled baritone (S2) says, <d>[English] We're not docking.</d> He turns his back to the harbor lights, looks down into the black water, and holds still until the final frame.

overall_soundscape: Deep diesel engine thrum reverberates through steel deck plating under the constant rushing wash of ferry wake. Cold wind flutters heavy wool coat lapels, wet steel cables creak in tension, and a distant harbor foghorn moans across the water.

non_diegetic_music: N/A
```

## t2va_freight_elevator

**t2va, 345 frames, 14.375 s.** Live-action handheld 35mm; two-person operative dialogue inside an industrial freight elevator, three shots with cuts, S1/S2 tags; N/A. **Tests:** Close-up two-person dialogue in an industrial freight elevator, hard room tone, no music; lines spoken on- and off-screen.

Derived: camera: Push In, Shake Slightly; speakers: S1, S2; languages: English; cuts: the camera cuts to; 187 words in the main field; 1444 characters in all.

```
python bench/grade_prompt_text.py --mode t2va --length 345 prompt_bank/t2va_freight_elevator.txt
  0 FAIL, 0 WARN
```

```text
integrated_multimodal_description: [Shot 1] Live-action, cinematic, handheld on 35mm, a medium two-shot frames an operative in a damp charcoal trench coat facing a partner in a dark canvas jacket inside a grinding industrial freight elevator, illuminated by a harsh yellow sodium fixture overhead. The operative with the low raspy baritone (S1) says, <d>[English] Override the panel before we hit twelve.</d> The partner produces no vocal sound as his jaw tightens. Her shoulders brace and the camera shakes slightly with the elevator's heavy vibration. [Shot 2] At 00:06.000, the camera cuts to a close-up of the operative against grease-streaked steel mesh, amber light reflecting in her eyes. Off screen the partner with the strained hoarse tenor (S2) answers, <d>[English] If I cut the cable, we drop.</d> The camera pushes in with small amplitude at slow speed toward her face. [Shot 3] At 00:11.000, the camera cuts to a close shot of the partner gripping an emergency release lever, cables whipping past the gate behind him. He (S2) says, <d>[English] Hold on.</d> He pulls the release handle down, sets his boots against the steel plate, and braces until the final frame.

overall_soundscape: Heavy industrial elevator rattle with rhythmic cable slap against steel beams and a low electrical motor hum. Wire mesh shudders under tension, boots shift on corrugated steel plate, and an iron gear groans under load.
...
## t2va_hospital_fire_escape

**t2va, 345 frames, 14.375 s.** Live-action handheld 35mm; surgical resident and senior surgeon confrontation on exterior fire escape, three shots with cuts, S1/S2 tags; N/A. **Tests:** Exterior dialogue in damp ambient soundscape with drifting steam, lines spoken on- and off-screen.

Derived: camera: Push In, Shake Slightly; speakers: S1, S2; languages: English; cuts: the camera cuts to, the shot cuts to; 189 words in the main field; 1439 characters in all.

```
python bench/grade_prompt_text.py --mode t2va --length 345 prompt_bank/t2va_hospital_fire_escape.txt
  0 FAIL, 0 WARN
```

```text
integrated_multimodal_description: [Shot 1] Live-action, cinematic, handheld on 35mm, a medium two-shot frames a surgical resident in jade scrubs under an open wool overcoat confronting a senior surgeon in a dark trench coat on an exterior metal fire escape, cold bluish doorway light cutting through drifting roof steam. The resident with the tight breathless soprano (S1) says, <d>[English] The surgical chart was altered this morning.</d> The senior surgeon produces no vocal sound as his jaw sets. Her mouth seals shut and the camera pushes in with small amplitude at slow speed toward the railing. [Shot 2] At 00:05.800, the shot cuts to a close-up of the resident against rain-streaked brick, steam curling past her collar. The senior surgeon with the deep gravelled baritone (S2) answers off screen, <d>[English] Nobody signed off on that audit.</d> The camera shakes slightly in the wet wind. [Shot 3] At 00:10.800, the camera cuts to a close shot of the senior surgeon flicking cigarette ash into the foggy darkness below. He (S2) says, <d>[English] Walk away.</d> He turns his collar up against the rain, looks toward the exit door, and holds still until the final frame.

overall_soundscape: Damp city traffic hums at a distance under the steady hiss of an exhaust vent releasing steam. Raindrops ping against painted iron treads, damp fabric rustles, and a metal security door clicks shut on its latch.
...
## t2va_motel_breezeway

**t2va, 345 frames, 14.375 s.** Live-action handheld 35mm; fugitive woman and hired driver motel walkway exchange, three shots with cuts, S1/S2 tags; N/A. **Tests:** Highway ambient and bug zapper soundscape, truck left and shake slightly, off-screen dialogue response.

Derived: camera: Truck Left, Shake Slightly; speakers: S1, S2; languages: English; cuts: the camera cuts to, the shot transitions to; 183 words in the main field; 1426 characters in all.

```
python bench/grade_prompt_text.py --mode t2va --length 345 prompt_bank/t2va_motel_breezeway.txt
  0 FAIL, 0 WARN
```

```text
integrated_multimodal_description: [Shot 1] Live-action, cinematic, handheld on 35mm, a medium two-shot frames a fugitive woman in a dark denim jacket facing a hired driver in a hooded nylon jacket on an open motel walkway, lit by a buzzing yellow bug lamp beside room twenty-four. The woman with the hushed sharp mezzo-soprano (S1) says, <d>[English] Hand over the car keys now.</d> The driver produces no vocal sound, tapping his jacket pocket. The camera trucks left with small amplitude at slow speed along the iron railing. [Shot 2] At 00:05.400, the camera cuts to a close-up of the woman pressed against weathered stucco, car headlights flashing across her cheek from the parking lot. She (S1) says, <d>[English] Headlights by the office.</d> The camera shakes slightly with the operator's breathing. [Shot 3] At 00:10.600, the shot transitions to a close shot of the driver peering over the balcony rail into the rainy lot below. The driver with the raspy low baritone (S2) says, <d>[English] That's not my car.</d> He draws his hood low over his forehead, reaches for his pocket, and holds still until the final frame.

overall_soundscape: Ambient highway traffic hums across wet asphalt in the distance under the persistent high-pitched buzz of an amber insect zapper. Car keys jingle sharply against denim, sneakers scuff on painted concrete decking, and distant tires crunch on wet gravel.
...
## t2va_none_of_this_is_real

**t2va, 345 frames, 14.375 s.** Live-action; one woman at a rooftop rail speaks a single short line to camera in the first five seconds and is silent after; the audio-freeze lane's voice scene, transcript carried in <d> **Tests:** lip sync against a frozen spoken clip: the mouth should move only while the clip speaks and close for the silent tail; the free-audio twin generates the line

Derived: camera: Static Shot; speakers: S1; languages: English; 131 words in the main field; 986 characters in all.

```
python bench/grade_prompt_text.py --mode t2va --length 345 prompt_bank/t2va_none_of_this_is_real.txt
  0 FAIL, 0 WARN
```

```text
integrated_multimodal_description: [Shot 1] Live-action, cinematic, a medium close-up frames a woman in her thirties standing at the rail of a rooftop at dusk across the fourteen-second take, city lights soft and out of focus behind her, a light wind moving strands of her dark hair. She is on-screen, with a clear, measured mezzo (S1), and she looks straight into the lens and says, unhurried: <d>[English] It doesn't matter, Nicola Coughlan. None of this is real.</d> Her lips close and her jaw stops moving. She holds the look for a long beat, then turns her head slowly toward the city, her lips closed, and rests both forearms on the rail. The camera holds a static shot as the wind lifts her hair and the lights behind her drift slightly with the shallow focus.

overall_soundscape: A steady wind moves across the rooftop with faint distant traffic far below, a flag rope ticks against a pole somewhere off frame, and her coat fabric rustles as she turns.
...
**t2va, 345 frames, 14.375 s.** The rooftop line with action inside the speech (a hand off the rail, a head shake, a half-smile, wind throughout, a slow push-in), after the owner read the still version as barely moving until the audio stopped **Tests:** whether stillness during a frozen line is the prompt's doing: same clip, same seed, action described during the words

Derived: camera: Push In; speakers: S1; languages: English; 170 words in the main field; 1182 characters in all.

```
python bench/grade_prompt_text.py --mode t2va --length 345 prompt_bank/t2va_none_of_this_is_real_moving.txt
  0 FAIL, 0 WARN
```

```text
integrated_multimodal_description: [Shot 1] Live-action, cinematic, a medium close-up frames a woman in her thirties at the rail of a rooftop at dusk across the fourteen-second take, city lights soft and out of focus behind her, a steady wind moving her dark hair and the collar of her coat the whole time. She is on-screen, with a clear, measured mezzo (S1). She lifts one hand off the rail as she speaks, opens it toward the city on the name, and gives a slow shake of her head on the last words, a half-smile breaking as she looks into the lens and says: <d>[English] It doesn't matter, Nicola Coughlan. None of this is real.</d> Her lips close and her jaw stops moving as the hand drops back to the rail. She holds the look, breathing visibly, then turns her head slowly toward the city and leans her forearms on the rail, her lips closed, the wind still working at her hair. The camera pushes in slowly at small amplitude through the whole take.

overall_soundscape: A steady wind moves across the rooftop with faint distant traffic far below, a flag rope ticks against a pole somewhere off frame, and her coat fabric rustles as she gestures and turns.
...
**t2va, 345 frames, 14.375 s.** The rooftop line delivered still while the camera arcs around her; one of three motion arms **Tests:** whether camera motion during a frozen line keeps the lip sync, with the subject held

Derived: camera: Arc Shot; speakers: S1; languages: English; 148 words in the main field; 1069 characters in all.

```
python bench/grade_prompt_text.py --mode t2va --length 345 prompt_bank/t2va_none_of_this_is_real_moving_camera.txt
  0 FAIL, 0 WARN
```

```text
integrated_multimodal_description: [Shot 1] Live-action, cinematic, a medium close-up frames a woman in her thirties at the rail of a rooftop at dusk across the fourteen-second take, city lights soft and out of focus behind her, a steady wind moving her dark hair and the collar of her coat the whole time. She is on-screen, with a clear, measured mezzo (S1), both hands resting on the rail, and she keeps her eyes on the lens as she says, unhurried: <d>[English] It doesn't matter, Nicola Coughlan. None of this is real.</d> Her lips close and her jaw stops moving. She holds the look for a long beat, then turns her head slowly toward the city, her lips closed. The camera moves in an arc shot around her at slow speed through the whole take, the city lights sliding across the background behind her head, ending on her profile against the skyline.
...
## t2va_none_of_this_is_real_moving_subject

**t2va, 345 frames, 14.375 s.** The rooftop line with the subject moving (hand, head, eyebrows, a half-smile, shoulders) and the camera static; one of three motion arms after the owner read the still version as a talking head **Tests:** whether subject motion during a frozen line keeps the lip sync and reads as natural, with the camera held

Derived: camera: Static Shot; speakers: S1; languages: English; 165 words in the main field; 1166 characters in all.

```
python bench/grade_prompt_text.py --mode t2va --length 345 prompt_bank/t2va_none_of_this_is_real_moving_subject.txt
  0 FAIL, 0 WARN
```

```text
integrated_multimodal_description: [Shot 1] Live-action, cinematic, a medium close-up frames a woman in her thirties at the rail of a rooftop at dusk across the fourteen-second take, city lights soft and out of focus behind her, a steady wind moving her dark hair and the collar of her coat the whole time. She is on-screen, with a clear, measured mezzo (S1). She lifts one hand off the rail as she speaks, opens it toward the city on the name, tilts her head and gives a slow shake of it on the last words, eyebrows lifting and a half-smile breaking as she looks into the lens and says: <d>[English] It doesn't matter, Nicola Coughlan. None of this is real.</d> Her lips close and her jaw stops moving as the hand drops back to the rail. She holds the look, breathing visibly, shoulders easing, then turns her head slowly toward the city and leans her forearms on the rail, her lips closed. The camera holds a static shot throughout.
...
## t2va_none_of_this_is_real_untold

**t2va, 345 frames, 14.375 s.** The same rooftop scene with the spoken line described but not transcribed (no <d> block); the audio-freeze lane's idea 4 arm **Tests:** whether the transcript in the prompt matters when the audio is frozen: same scene, same seed, same clip, no words in the text

Derived: camera: Static Shot; speakers: S1; 123 words in the main field; 927 characters in all.

```
python bench/grade_prompt_text.py --mode t2va --length 345 prompt_bank/t2va_none_of_this_is_real_untold.txt
  0 FAIL, 0 WARN
```

```text
integrated_multimodal_description: [Shot 1] Live-action, cinematic, a medium close-up frames a woman in her thirties standing at the rail of a rooftop at dusk across the fourteen-second take, city lights soft and out of focus behind her, a light wind moving strands of her dark hair. She is on-screen, with a clear, measured mezzo (S1), and she looks straight into the lens and speaks one short unhurried line. Her lips close and her jaw stops moving. She holds the look for a long beat, then turns her head slowly toward the city, her lips closed, and rests both forearms on the rail. The camera holds a static shot as the wind lifts her hair and the lights behind her drift slightly with the shallow focus.
...
## t2va_parking_garage_pillar

**t2va, 345 frames, 14.375 s.** Live-action handheld 35mm; undercover detective and informant clandestine exchange behind parking garage pillar, three shots with cuts, S1/S2 tags; N/A. **Tests:** Subterranean cavernous concrete acoustic tone, truck left camera motion, lines spoken on- and off-screen.

Derived: camera: Truck Left, Shake Slightly; speakers: S1, S2; languages: English; cuts: the camera cuts to, the shot cuts to; 186 words in the main field; 1489 characters in all.

```
python bench/grade_prompt_text.py --mode t2va --length 345 prompt_bank/t2va_parking_garage_pillar.txt
  0 FAIL, 0 WARN
```

```text
integrated_multimodal_description: [Shot 1] Live-action, cinematic, handheld on 35mm, a medium two-shot frames an undercover detective in a black windbreaker confronting an informant in a soiled canvas jacket behind a concrete support pillar in an underground parking garage, lit harsh from a buzzing fluorescent tube overhead. The detective with the hushed gravelly baritone (S1) says, <d>[English] Tell me where you stashed the ledger.</d> The informant produces no vocal sound, gesturing anxiously toward the ramp. The camera trucks left with small amplitude at slow speed along the damp concrete. [Shot 2] At 00:05.600, the camera cuts to a close-up of the informant against water-stained concrete, his eyes darting toward the ramp. The informant with the trembling reedy tenor (S2) says, <d>[English] Keys are under the floor mat.</d> The camera shakes slightly with his nervous breathing. [Shot 3] At 00:10.800, the shot cuts to a tight medium shot of the detective reaching inside her coat, distant car beams sweeping the pillar behind her. She (S1) says, <d>[English] Move behind the pillar now.</d> She pulls the informant behind the pillar, steps into the shadow, and holds still until the final frame.

overall_soundscape: Distant engine rumble echoes across cavernous subterranean concrete under a persistent fluorescent tube buzz. Water drips irregularly into a shallow puddle, rubber shoe soles squeak on smooth pavement, and a car exhaust idles low.
...
## t2va_precinct_archive_vault

**t2va, 345 frames, 14.375 s.** Live-action handheld 35mm; internal affairs investigator and archivist basement records vault interrogation, three shots with cuts, S1/S2 tags; N/A. **Tests:** Cavernous records basement acoustic room tone, push in and static shot, off-screen dialogue responses.

Derived: camera: Push In, Static Shot; speakers: S1, S2; languages: English; cuts: the camera cuts to, the shot switches to; 181 words in the main field; 1445 characters in all.

```
python bench/grade_prompt_text.py --mode t2va --length 345 prompt_bank/t2va_precinct_archive_vault.txt
  0 FAIL, 0 WARN
```

```text
integrated_multimodal_description: [Shot 1] Live-action, cinematic, handheld on 35mm, a medium two-shot frames an internal affairs investigator in a charcoal suit confronting a senior archivist in a wool cardigan between green metal shelves in a basement records vault, lit by a single shaded tungsten desk lamp. The investigator with the clipped low baritone (S1) says, <d>[English] The homicide log is missing from this shelf.</d> The archivist produces no vocal sound, wire-rim spectacles sliding down his nose. The camera pushes in with small amplitude at slow speed between the tall shelves. [Shot 2] At 00:05.800, the camera cuts to a close-up of the archivist, wire-rim spectacles catching the tungsten beam. The archivist with the dry cracked tenor (S2) says, <d>[English] Someone forced the records cage this morning.</d> The camera holds a static shot on his trembling fingers. [Shot 3] At 00:11.000, the shot switches to a close-up of the investigator beside a locked steel security gate. She (S1) says, <d>[English] Then someone took it.</d> Her jaw tightens, she looks down at the severed padlock on the floor, and holds still until the final frame.

overall_soundscape: Cavernous basement room tone echoes with the low dull hum of a ventilation intake duct. Heavy metal drawer rollers slide open with a dry screech, dense cardstock folders flap as pages turn, and leather shoes squeak on polished linoleum.
...
## t2va_rooftop_boiler_room

**t2va, 345 frames, 14.375 s.** Live-action handheld 35mm; investigator and building superintendent rooftop boiler room confrontation, three shots with cuts, S1/S2 tags; N/A. **Tests:** Rain on corrugated tin roof soundscape, truck right and static shot, off-screen dialogue response.

Derived: camera: Truck Right, Static Shot; speakers: S1, S2; languages: English; cuts: the camera cuts to, the shot cuts to; 183 words in the main field; 1448 characters in all.

```
python bench/grade_prompt_text.py --mode t2va --length 345 prompt_bank/t2va_rooftop_boiler_room.txt
  0 FAIL, 0 WARN
```

```text
integrated_multimodal_description: [Shot 1] Live-action, cinematic, handheld on 35mm, a medium two-shot frames a private investigator in a wet wool pea coat facing a building superintendent in stained denim overalls inside a rooftop boiler room, lit by an amber caged work lamp swinging overhead. The investigator with the low gravelled baritone (S1) says, <d>[English] Someone forced the fire door open.</d> The superintendent produces no vocal sound, gripping his pipe wrench. The camera trucks right with small amplitude at slow speed past insulated steam pipes. [Shot 2] At 00:05.600, the shot cuts to a close-up of the investigator holding a muddied work glove under the caged bulb. She (S1) says, <d>[English] Found near the ledge.</d> The camera holds a static shot on the frayed fabric. [Shot 3] At 00:10.800, the camera cuts to a close shot of the superintendent staring at the open fire door, night rain whipping through the doorway behind him. The superintendent with the raspy weathered tenor (S2) says, <d>[English] Lock was forced.</d> He tightens his grip on a heavy pipe wrench, glares into the dark, and holds still until the final frame.

overall_soundscape: Heavy rain drums rhythmically on corrugated tin roofing under the dull whoosh of a gas boiler burner. Iron pipe joints creak under thermal expansion, heavy brass keys jingle on a steel belt ring, and water drips steadily into a galvanized bucket.

non_diegetic_music: N/A
```

## t2va_safehouse_kitchen

**t2va, 345 frames, 14.375 s.** Live-action handheld 35mm; three-person covert operative dialogue in safehouse kitchen, three shots with cuts, S1/S2/S3 tags; N/A. **Tests:** Three-speaker dialogue exchange, pan left camera motion, rapid pacing across cuts.

Derived: camera: Push In, Pan Left; speakers: S1, S2; languages: English; cuts: the camera cuts to, the shot cuts to; 181 words in the main field; 1385 characters in all.

```
python bench/grade_prompt_text.py --mode t2va --length 345 prompt_bank/t2va_safehouse_kitchen.txt
  0 FAIL, 0 WARN
```

```text
integrated_multimodal_description: [Shot 1] Live-action, cinematic, handheld on 35mm, a wide shot frames three operatives inside a dimly lit safehouse kitchen, streetlamp beams cutting through venetian blinds across a bare wooden table. A lookout at the window with a low brisk alto (S1) says, <d>[English] Unmarked sedan parked on the curb.</d> The team leader at the table produces no vocal sound and signals with his hand. The camera pans left with small amplitude at slow speed from the window to the table. [Shot 2] At 00:05.600, the shot cuts to a close medium shot of the leader and the technician packing hard drives into a nylon bag. The team leader with the steady raspy baritone (S2) orders, <d>[English] Wipe the drive and take the back door.</d> The camera pushes in with small amplitude at slow speed toward their hands. [Shot 3] At 00:10.600, the camera cuts to a close-up of the lookout reaching for the doorknob, wood splintering outside. She (S1) says, <d>[English] Too late.</d> She draws her shoulder against the door frame, raises her sidearm, and holds still until the final frame.

overall_soundscape: Muffled street traffic murmurs through closed double-hung glass under a faint refrigerator motor vibration. Plastic laptop keys clack rapidly, venetian blind slats click as fingers part them, and floorboards groan under shifting boots.
...
**t2va, 345 frames, 14.375 s.** Live-action; a lone dancer in a rehearsal studio moving to a fast drum-machine pulse from a floor speaker, two shots cut on the beat grid; the audio-freeze lane's music scene (docs/h3_audio_freeze.md) **Tests:** whether the picture follows a frozen instrumental track: isolations and drops on the hits, a cut on the beat grid; the free-audio twin generates the music the prompt describes

Derived: camera: Push In, Static Shot; cuts: the shot cuts to; 182 words in the main field; 1287 characters in all.

```
python bench/grade_prompt_text.py --mode t2va --length 345 prompt_bank/t2va_studio_dancer.txt
  0 FAIL, 0 WARN
```

```text
integrated_multimodal_description: [Shot 1] Live-action, cinematic, a wide shot frames a bare dance rehearsal studio across the fourteen-second take, sprung wooden floor, one mirrored wall, a single portable speaker on the floor by the mirror playing a fast, dry drum-machine pulse. A dancer in her twenties in a grey vest and loose black trousers stands centre frame, produces no vocal sound, and moves to the beat: sharp isolations of the shoulders and head on every hit, weight dropping into the knees on the downbeats, both arms snapping out and folding back in time. The camera holds a static shot as her footwork widens into a full-body groove that fills the frame. [Shot 2] At 00:06.316, the shot cuts to a medium shot from the mirror side, her reflection sharing the frame, as she turns on the beat and hits a pose, then breaks it into a rolling step sequence that lands on every fourth hit. Her lips stay closed throughout. The camera pushes in slowly at small amplitude as she stops square to the lens on a final hit and holds still, chest rising.
...
```
python bench/grade_prompt_text.py --mode t2va --length 345 prompt_bank/t2va_studio_dancer_close.txt
  0 FAIL, 0 WARN
```
...
## t2va_subway_maintenance_alcove

**t2va, 345 frames, 14.375 s.** Live-action handheld 35mm; senior track inspector and junior lineman subway tunnel dialogue, three shots with cuts, S1/S2 tags; N/A. **Tests:** Subway tunnel bedrock acoustics, emergency flare visual effects, push in camera motion.

Derived: camera: Push In, Shake Slightly; speakers: S1, S2; languages: English; cuts: the camera cuts to, the shot switches to; 185 words in the main field; 1462 characters in all.

```
python bench/grade_prompt_text.py --mode t2va --length 345 prompt_bank/t2va_subway_maintenance_alcove.txt
  0 FAIL, 0 WARN
```

```text
integrated_multimodal_description: [Shot 1] Live-action, cinematic, handheld on 35mm, a medium two-shot frames a senior track inspector facing a junior lineman inside a dark tiled subway alcove, lit by the red glow of a battery work lantern on the track ballast. The senior inspector with the weathered booming baritone (S1) says, <d>[English] The third rail is already live.</d> The junior lineman produces no vocal sound, eyes wide with alarm. The camera pushes in with small amplitude at slow speed toward the steel tracks. [Shot 2] At 00:05.800, the camera cuts to a close-up of the senior inspector against grime-filmed tunnel tiles, amber tunnel air buffeting his jacket. He (S1) says, <d>[English] Light the emergency flare at the junction.</d> The camera shakes slightly as tunnel wind intensifies. [Shot 3] At 00:11.000, the shot switches to a close-up of the junior lineman striking an emergency magnesium flare, red sparks washing across his hard hat. The junior lineman with the anxious hoarse tenor (S2) says, <d>[English] Train incoming.</d> He holds the burning flare high above the third rail, plants his feet on the ballast, and braces until the final frame.

overall_soundscape: Heavy low-frequency rail vibration pulses through tunnel bedrock under the steady hiss of damp track ballast. Metal tools clatter inside a leather pouch, heavy boots scuff on gravel, and an electric hum resonates along the steel third rail.
...
**ref2va, 345 frames, 14.375 s, donor `h3_probe_refview2_diner_api`.** The diner breakup with both speakers and the room carried from three pictures; the room's black-and-white still is re-lit in neon. **Tests:** reference-view ablation scene (bench/refview2_arms.json): identity carry per copy of the still, blind over seeds Ships in: `h3_probe_refview2_diner_api`.

Derived: camera: Push In, Pull Out, Static Shot; speakers: S1, S2; languages: English; cuts: the camera cuts to, the shot cuts to; task: [reference generation]; labels: <Picture 1>, <Picture 2>, <Picture 3>; 444 words in the main field; 5137 characters in all.

```
python bench/grade_prompt_text.py --mode ref2va --length 345 --like h3_probe_refview2_diner_api prompt_bank/ref2va_diner_breakup_refs.txt
  0 FAIL, 0 WARN
```
...
**ref2va, 345 frames, 14.375 s, donor `h3_probe_refview2_porter_api`.** The night porter carried from one picture of a dog-headed man; one sung line, two shots. **Tests:** reference-view ablation scene (bench/refview2_arms.json): identity carry per copy of the still, blind over seeds Ships in: `h3_probe_refview2_porter_api`.

Derived: camera: Zoom In, Static Shot; speakers: S1; languages: English; cuts: the camera cuts to; task: [reference generation]; labels: <Picture 1>; 350 words in the main field; 3279 characters in all.

```
python bench/grade_prompt_text.py --mode ref2va --length 345 --like h3_probe_refview2_porter_api prompt_bank/ref2va_night_porter_refs.txt
  0 FAIL, 0 WARN
```
...
**ref2va, 345 frames, 14.375 s, donor `h3_probe_refview2_stairwell_backstage_api`.** The stairwell dialogue with both speakers carried from ONE picture (a backstage selfie pair): two subjects, one <Picture 1>. **Tests:** reference-view ablation scene (bench/refview2_arms.json): identity carry per copy of the still, blind over seeds Ships in: `h3_probe_refview2_stairwell_backstage_api`.

Derived: camera: Shake Slightly; speakers: S1, S2; languages: English; cuts: the camera cuts to; task: [reference generation]; labels: <Picture 1>; 419 words in the main field; 4141 characters in all.

```
python bench/grade_prompt_text.py --mode ref2va --length 345 --like h3_probe_refview2_stairwell_backstage_api prompt_bank/ref2va_stairwell_dialogue_backstage.txt
  0 FAIL, 0 WARN
```
...
**ref2va, 345 frames, 14.375 s, donor `h3_probe_refview2_stairwell_circus_api`.** The stairwell dialogue as stylised 3D animation, the two speakers carried from two animated-character stills; a medium and identity carry at once. **Tests:** reference-view ablation scene (bench/refview2_arms.json): identity carry per copy of the still, blind over seeds Ships in: `h3_probe_refview2_stairwell_circus_api`.

Derived: camera: Shake Slightly; speakers: S1, S2; languages: English; cuts: the camera cuts to; task: [reference generation]; labels: <Picture 1>, <Picture 2>; 422 words in the main field; 4313 characters in all.

```
python bench/grade_prompt_text.py --mode ref2va --length 345 --like h3_probe_refview2_stairwell_circus_api prompt_bank/ref2va_stairwell_dialogue_circus.txt
  0 FAIL, 0 WARN
```
...
Derived: camera: Push In, Static Shot; cuts: the shot cuts to; task: [reference generation]; labels: <Picture 1>; 370 words in the main field; 3244 characters in all.

```
python bench/grade_prompt_text.py --mode ref2va --length 345 --like h3_probe_refview2_dancer_api prompt_bank/ref2va_studio_dancer_close_refs.txt
  0 FAIL, 0 WARN
```
