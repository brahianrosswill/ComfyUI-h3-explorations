...
| **"Sol without sage is worse than the sage floor" as settled**, read from the just-Sol verdict ([`bench/results/2026-09-05_sol_nosage_2026-09-04_verdict.json`](../bench/results/2026-09-05_sol_nosage_2026-09-04_verdict.json)) | **Bounded, 2026-09-05.** One seed, five scenes, pairs only, singles unscored. The floor won four with one can't-tell and Sol as shipped won three with two same, but the notes name composition on all but one pair (framing, the orchestra behind the singer, the diner menu, the suspect behind the chaser), which is sample divergence; the one quality loss is stairwell (lighting, skin fidelity, level). Direction against just-Sol, evidence weak; the shipped chain stays the leader on the 2026-09-03 ladder verdict, not on this. |
