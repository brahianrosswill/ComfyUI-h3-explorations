...
|---|---|---|---|---|---|---|
| [`LONG_T2V_PROMPT`](#long-t2v-prompt) | `t2va_covered_market` | 40 | 281 | 3 | 2 | `<d>` |
...
Carried by **40** graph(s). Sections: `integrated_multimodal_description`, `overall_soundscape`, `non_diegetic_music`.
...
- `h3_probe_t2v_ck_api`
- `h3_probe_t2v_ck_dense_tail_api`
